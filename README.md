...
body{
    background-color: black; /* Mengatur latar belakang menjadi putih */
    color: rgb(244, 248, 5); /* Pastikan teks terlihat jelas */
    font-weight: bold;
    font-size: 16px;
}
h1{
    color: #C71585 !important; /* Warna pink */
}
.proses-desain {
    color: green;
}
